...
class RSIMomentumStrategy(BaseStrategy):
    ...
    async def on_candle(self, candle: dict) -> Optional[Signal]:
        ...
        # Momentum Mantığı: RSI 50'nin üzerindeyse yükseliş momentumu, altındaysa düşüş momentumu
        if current_rsi > 60: # Güçlü yükseliş momentumu
            return Signal(symbol=symbol, side=OrderSide.BUY, strength=0.6, strategy_name=self.name)
        elif current_rsi < 40: # Güçlü düşüş momentumu
